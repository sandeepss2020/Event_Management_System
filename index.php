...
<style>
  ...
  #header:before{
    ...
    height:calc(100%);
    width:calc(100%);
    background-image:url('./images//celebrate1.jpg');
     ...
     <?php if($_settings->chk_flashdata('success')): ?>
      ...
      <div class="content-wrapper pt-5"   >
        <?php if($page == "home" || $page == "about_us"): ?>
          <div id="header" class="shadow mb-4"style="background-image: linear-gradient(to right top, #051937, #004d7a, #008793, #00bf72, #a8eb12);" >
              <div class="d-flex justify-content-center h-100 w-100 align-items-center flex-column px-3" >
                  <h1 class="w-60 text-center site-title px-5" style="font-family: Georgia, serif;"><?php echo $_settings->info('name') ?></h1>
                  <button class="btn btn-lg btn-default bg-gradient-maroon border-0 rounded-pill px-4 w-25" id="book_now">Book Now!</button>
              </div>
          </div>
        <?php endif; ?>
        <!-- Main content -->
        <section class="content " style="background-image: linear-gradient(to right bottom, #f69a03, #f4b748, #f4d07a, #f7e7ac, #fffcdf);">
          <div class="container"  >
