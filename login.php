...
<body class="hold-transition ">
  ...
  <style>
    ...
    body{
      background-image: url(""whbs\logo-1643592116.jpg"");
  ...
  <div class="h-100 d-flex align-items-center w-100" id="login" >
    <div class="col-7 h-100 d-flex align-items-center justify-content-center" style="background-image: url('./images//img1.jpg'); background-size: cover; background-position: center; ">
      <div class="w-100">
