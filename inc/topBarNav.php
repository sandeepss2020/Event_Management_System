...
<!-- Navbar -->
      ...
      <nav class="w-100 px-2 py-1 position-fixed top-0  text-light" id="login-nav" style="background-color:#F69A03; font-size: 15px;">
      ...
      <nav class="main-header navbar navbar-expand navbar-light border-0 text-sm" id='top-Nav' style="background-color:
#F69A03;">
        ...
        <div class="container" style="font-size:15px;">
          ...
          <div class="collapse navbar-collapse order-3" id="navbarCollapse">
            ...
            <ul class="navbar-nav">
              <li class="nav-item">
                <a href="./" class="nav-link <?= isset($page) && $page =='home' ? "active" : "" ?>" style="height:25px;">Home</a>
              </li>
              <li class="nav-item">
                <a href="./?page=halls" class="nav-link <?= isset($page) && $page =='halls' ? "active" : "" ?>">Events</a>
              </li>
              <li class="nav-item">
